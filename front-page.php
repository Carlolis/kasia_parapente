...
<html lang="en">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,400;0,500;0,700;0,800;0,900;1,700&display=swap"
      rel="stylesheet"
    />
    ...
    <section id="hero">
      <header>
        <nav>
          ...
          <div class="social_media">
            <img id="fb" src="icones/facebook.svg" alt="facebook" />
            <img id="ig" src="icones/instagram.svg" alt="instagram" />
            <img id="yt" src="icones/youtube.svg" alt="youtube" />
          </div>
        </nav>
      </header>
      ...
      <div class="hero_box">
        ...
        <div class="icones-fixes">
          <div id="rs2">
            <img id="search" src="icones/search.svg" alt="" />
          </div>
          <div class="rs">
            <img id="shop" class="rs" src="icones/shopping-cart.svg" alt="" />
          </div>
          <div class="rs">
            <img id="user" class="rs" src="icones/user.svg" alt="" />
          </div>
        </div>
